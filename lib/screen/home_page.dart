...
import 'package:metre_mobile/screen/mesa_page.dart';
          ...
          if (snapshot.hasData) {
            switch (snapshot.connectionState) {
              ...
              case ConnectionState.done:
                ...
                mesas = mesas
                    .where((m) =>
                        m.situacao == 'Aberta' || m.situacao == 'Recebendo')
                    .toList();
                mesas.sort((m1, m2) => int.parse(m1.numeroMesa)
                    .compareTo(int.parse(m2.numeroMesa)));
